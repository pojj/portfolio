...
@Component({
  selector: 'app-variant-blueprint',
  templateUrl: './variant-blueprint.component.html',
  styleUrls: ['./variant-blueprint.component.css'],
})
export class VariantBlueprintComponent {
  p = PROFILE;
  exp = EXPERIENCE;
  projects = PROJECTS;
  skills = SKILLS;
